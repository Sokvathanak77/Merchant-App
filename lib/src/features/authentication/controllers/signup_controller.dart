...
class SignUpController extends GetxController {
  ...
  /// Register New User using [PhoneNumber] authentication
  Future<void> createPhoneUser(String phoneNumber) async {
    try {
      ...
      SignUpController.instance.phoneAuthentication(phoneNumber).then((value) => Get.to(() => OTPScreen(phone: phoneNumber,)));
  ...
  Future<void> createUser() async {
    try {
      ...
      // SignUpController.instance.phoneAuthentication(phoneNo.text.trim());
